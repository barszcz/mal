...
var _user$project$Mal$input = _elm_lang$core$Native_Platform.incomingPort('input', _elm_lang$core$Json_Decode$string);
var _user$project$Mal$output = _elm_lang$core$Native_Platform.outgoingPort(
	'output',
	function (v) {
		return v;
	});
var _user$project$Mal$close = _elm_lang$core$Native_Platform.incomingPort(
	'close',
	_elm_lang$core$Json_Decode$succeed(
		{}));
var _user$project$Mal$end = _elm_lang$core$Native_Platform.outgoingPort(
	'end',
	function (v) {
		return v;
	});
var _user$project$Mal$update = F2(
	function (action, model) {
		...
		if (_p0.ctor === 'Echo') {
			return {
				ctor: '_Tuple2',
				_0: model,
				_1: _user$project$Mal$output(_p0._0)
			};
		} else {
			return {
				ctor: '_Tuple2',
				_0: model,
				_1: _user$project$Mal$end(0)
			};
		}
	});
var _user$project$Mal$Close = {ctor: 'Close'};
var _user$project$Mal$Echo = function (a) {
	return {ctor: 'Echo', _0: a};
};
var _user$project$Mal$echo = function (a) {
	return _user$project$Mal$Echo(a);
};
var _user$project$Mal$main = _elm_lang$core$Platform$program(
	{
		init: {ctor: '_Tuple2', _0: 0, _1: _elm_lang$core$Platform_Cmd$none},
		update: _user$project$Mal$update,
		subscriptions: function (_p1) {
			return _elm_lang$core$Platform_Sub$batch(
				{
					ctor: '::',
					_0: _user$project$Mal$input(_user$project$Mal$echo),
					_1: {
						ctor: '::',
						_0: _user$project$Mal$close(
							function (_p2) {
								return _user$project$Mal$Close;
							}),
						_1: {ctor: '[]'}
					}
				});
...
var Elm = {};
Elm['Mal'] = Elm['Mal'] || {};
if (typeof _user$project$Mal$main !== 'undefined') {
    _user$project$Mal$main(Elm['Mal'], 'Mal', undefined);
}
